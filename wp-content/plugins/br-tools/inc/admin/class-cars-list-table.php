 ...
 */
class Cars_List_Table extends Libraries\WP_List_Table  {
	...
	public function get_columns() {
		...
		$table_columns = array(
            ...
            'model'		        =>	__( 'Модель', $this->plugin_text_domain ),
			'series'	        => __( 'Серия',  $this->plugin_text_domain ),
			'body_type'		    =>	__( 'Тип кузова', $this->plugin_text_domain ),
			'modification'		=>	__( 'Модификация', $this->plugin_text_domain ),
			'year_of_issue'		=>	__( 'Год выпуска', $this->plugin_text_domain ),
	...
	public function page_edit( $id ) {
		...
		include_once( 'views/cars/edit.php' );
	}
        ...
        if(isset($post['brand'])){
            $wpdb->update(
                ...
                array(
                    ...
                    'year_of_issue'=>$post['year_of_issue'],
