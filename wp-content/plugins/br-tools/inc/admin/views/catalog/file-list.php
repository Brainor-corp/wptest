...
<div class="wrap">    
    ...
    <div class="alert alert-warning" role="alert">
        ...
        <p>Данные товаров в базе будут удалены и полность заменены товарами из файлов.</p>
        <p>Каждый файл дожен иметь название вида {Произвольное название}_{префикс города}.csv</p>
